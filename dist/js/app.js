(() => {
    ...
    const teamSliders = document.querySelector("#teamSlider .swiper-wrapper")?.children?.length;
    new core("#teamSlider", {
    ...
    class ScrollWatcher {
        ...
        scrollWatcherCallback(entry, observer) {
            ...
            if (targetElement.dataset.watch === "roadmap") if (entry.isIntersecting) {
                const firstSlide = document.querySelector(".roadmap-slide");
                targetElement.classList.add("_slider-view");
                counter(25, firstSlide.querySelector(".circle-loader__percent"));
                counter(25, firstSlide.querySelector(".linear-loader__percent"));
                firstSlide.classList.add("_anim-slide");
                addCheckToItems([ ...document.querySelector(".roadmap-list")?.children ]);
            }
        }
    }
    new ScrollWatcher({});
